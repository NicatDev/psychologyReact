    ...
    return (
        <div className="h-[90vh] relative">
            ...
            <div className="container px-2 mx-auto pt-5 relative z-20 text-white flex flex-col items-center justify-center h-full ">
                ...
                <Link className='border-4 font-medium px-12 py-3 border-bolid border-white text-xl hover:bg-white hover:text-emerald-900 duration-300' to='test'>Başlamaq</Link>
            </div>
        </div>
    )
}
