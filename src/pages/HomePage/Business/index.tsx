    ...
    return (
        <div className="h-[90vh] relative">
            ...
            <div className="container px-2 mx-auto pt-5 relative z-20 text-white flex flex-col items-center justify-center h-full ">
                <h2 className='text-3xl md:text-5xl w-1/2 mb-6 text-center leading-tight font-bold'>{t("home.business.title")}</h2>
                <p className='text-lg w-2/3 mb-8 text-center'>{t("home.business.description")}</p>
                <Link className='border-4 font-medium px-12 py-3 border-bolid border-white text-xl hover:bg-white hover:text-emerald-900 duration-300' to='test'>{t("home.business.start_button")}</Link>
            </div>
        </div>
    )
}
