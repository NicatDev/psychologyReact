...
const BlogDetail = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{blogDetail.title} | Octopus</title>
        <meta name="description" content={blogDetail.content.slice(0, 160)} />
        <meta property="og:title" content={blogDetail.title} />
        <meta property="og:description" content={blogDetail.content.slice(0, 160)} />
        {blogDetail.image && <meta property="og:image" content={blogDetail.image} />}
