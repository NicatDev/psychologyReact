...
const tests = [
  {
    ...
    description: "9 tip şəxsiyyət analiz testi",
    type: "INTJ",
  },
  {
    id: 2,
...
const questions = [
  {
    id: 1,
    text: "Mən öz hisslərimi ifadə etməkdə çətinlik çəkirəm",
    trueLabel: "Tam razıyam",
    falseLabel: "Heç razı deyiləm",
  },
  {
    id: 2,
    text: "Qərar verərkən çox düşünürəm",
    trueLabel: "Razıyam",
    falseLabel: "Razı deyiləm",
  },
  {
    id: 3,
    text: "İnsanlarla ünsiyyət mənə rahat gəlir",
    trueLabel: "Tam razıyam",
    falseLabel: "Heç razı deyiləm",
  },
  {
    id: 4,
    text: "Stresslə baş etməyi bacarıram",
    trueLabel: "Tam razıyam",
    falseLabel: "Heç razı deyiləm",
  },
  {
    id: 5,
    text: "Tənqidə qarşı həssasam",
    trueLabel: "Razıyam",
    falseLabel: "Razı deyiləm",
  },
];
...
export default function TestList() {
  ...
  const [activeTab, setActiveTab] = useState<"questions" | "result">(
    "questions"
  );
